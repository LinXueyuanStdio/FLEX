...
from util import flatten_query, eval_tuple, sizeof_fmt
...
class MyExperiment(Experiment):
    ...
    def __init__(self, output: OutputSchema, data: ComplexQueryData,
        ...
        self.log('beta mode = %s' % beta_mode)
...
@click.option("--name", type=str, default="BetaE", help="Name of the experiment.")
...
@click.option('--hidden_dim', default=500, type=int, help="embedding dimension")
@click.option('--gamma', default=12.0, type=float, help="margin in the loss")
@click.option('--learning_rate', default=0.0001, type=float)
@click.option('--cpu_num', default=10, type=int, help="used to speed up torch.dataloader")
