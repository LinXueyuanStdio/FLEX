...
from PercentagE_norm import PercentagE
...
class MyExperiment(Experiment):
    ...
    def __init__(self, output: OutputSchema, data: ComplexQueryData,
        ...
        self.model_param_store.save_scripts(["train_CQE_PercentagE_norm.py", "PercentagE_norm.py"])
...
@click.command()
@click.option("--dataset", type=str, default="FB15k-237", help="Which dataset to use: FB15k, FB15k-237 or NELL.")
