...
class MyExperiment(Experiment):
    ...
    def __init__(self, output: OutputSchema, data: RelationalTripletData,
        ...
        data.print(self.log)
        self.model_param_store.save_scripts(["train_TuckerE.py", "TuckerE.py"])
        ...
        # 3. build model
        model = TuckerE(data.entity_count, 2 * data.relation_count, edim).to(train_device)
...
@click.option("--name", type=str, default="TuckerE", help="Name of the experiment.")
