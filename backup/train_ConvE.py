...
from toolbox.nn.TuckER import TuckER
...
class MyExperiment(Experiment):
    ...
    def __init__(self, output: OutputSchema, data: RelationalTripletData,
        ...
        data.print(self.log)
        self.model_param_store.save_scripts(["train_ConvE.py"])
        ...
        # 3. build model
        model = ConvE(data.entity_count, 2 * data.relation_count, edim).to(train_device)
...
@click.option("--name", type=str, default="ConvE", help="Name of the experiment.")
