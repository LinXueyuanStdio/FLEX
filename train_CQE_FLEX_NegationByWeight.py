...
class Negation(nn.Module):
    def __init__(self, dim):
        ...
        self.dim = dim
        self.w = nn.Parameter(torch.rand(1, self.dim))
    ...
    def forward(self, feature, logic):
        ...
        # a' = a - 2wb + w
        # b' = 1 - b
        feature = feature - 2 * self.w * feature + self.w
        logic = 1 - logic
        return feature, logic
...
@click.option("--name", type=str, default="FLEX_NegationByMLP", help="Name of the experiment.")
